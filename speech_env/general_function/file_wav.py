...
def read_wav_data(filename):
	...
	'''
	print("======================"+filename)
	# folders = filename.split('/')[7]
	# if folders == "ST-CMDS-20170001_1-OS": 
	# 	filename = '/home/lihanghang/tensorflow/homework/cnn-asr/ASRT_SpeechRecognition-0.5.0/datasets/ST-CMDS-20170001_1-OS/' + filename.split('/')[8]
	# else:
	# 	filename = filename
	#filename = '/home/lihanghang/tensorflow/homework/cnn-asr/thchs30/ST-CMDS-20170001_1-OS/20170001P00411A0003.wav'
	
	wav = wave.open(filename.decode("utf-8"),"r") # 打开一个wav格式的声音文件流
...
def GetMfccFeature(wavsignal, fs):
	...
	# 返回值分别是mfcc特征向量的矩阵及其一阶差分和二阶差分矩阵sftp://124.16.71.33/home/lihanghang/tensorflow/homework/cnn-asr/thchs30
...
def get_wav_list(filename):
	...
	'''
	txt_obj=open(filename.decode("utf-8"),'r') # 打开文件并读入
