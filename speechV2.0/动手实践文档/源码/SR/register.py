...
def recordVoice(word,speakerName):
	...
	RATE = 44100
	RECORD_SECONDS = 4
	WAVE_OUTPUT_FILENAME = "./samples/"+speakerName+"-2018/"+speakerName+"_"+word+".wav"
...
def  train_model():
	...
	training_file = open('./training_sample_list.txt','w')
	os.mkdir("./samples/"+speakerName+"-2018")
	...
	dest = "./gmm_models/"
	train_file = "./training_sample_list.txt"        
